...
############################################################################
{
    ...
    'depends': ['point_of_sale', 'pos_restaurant', 'web', 'bus'],
    'data': [
        'security/pos_kitchen_screen_groups.xml',
        "security/ir.model.access.csv",
        'data/kitchen_screen_data.xml',
        'report/pos_kot_paperformat.xml',
        'report/pos_kot_report_templates.xml',
        'report/pos_kot_report_action.xml',
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            ...
            'pos_kitchen_screen_odoo/static/src/app/control_buttons/send_to_kitchen_button.js',
            'pos_kitchen_screen_odoo/static/src/app/control_buttons/send_to_kitchen_button.xml',
        ],
        'web.assets_backend': [
